...
try:
    ...
    add_introspection_rules([], ["^modulos\.django_google_maps\.fields\.GeoLocationField"])
    add_introspection_rules([], ["^modulos\.django_google_maps\.fields\.AddressField"])
    add_introspection_rules([], ["^modulos\.django_google_maps\.fields\.PathField"])
except ImportError:
    pass
