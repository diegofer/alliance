...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'usuarios_usuario', (
            ...
            ('ambito', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_admin', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_padre', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal(u'usuarios', ['Usuario'])

        # Adding M2M table for field groups on 'Usuario'
        m2m_table_name = db.shorten_name(u'usuarios_usuario_groups')
        ...
        m2m_table_name = db.shorten_name(u'usuarios_usuario_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usuario', models.ForeignKey(orm[u'usuarios.usuario'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'usuarios_usuario_groups'))

        # Removing M2M table for field user_permissions on 'Usuario'
        db.delete_table(db.shorten_name(u'usuarios_usuario_user_permissions'))
