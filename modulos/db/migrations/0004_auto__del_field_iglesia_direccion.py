...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Iglesia.direccion'
        db.delete_column(u'db_iglesia', 'direccion')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Iglesia.direccion'
        raise RuntimeError("Cannot reverse this migration. 'Iglesia.direccion' and its values cannot be restored.")
