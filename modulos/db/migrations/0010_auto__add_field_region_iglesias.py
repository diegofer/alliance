...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Region.iglesias'
        db.add_column(u'db_region', 'iglesias',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.iglesias'
        db.delete_column(u'db_region', 'iglesias')
    ...
    models = {
        ...
        u'db.region': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iglesias': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
