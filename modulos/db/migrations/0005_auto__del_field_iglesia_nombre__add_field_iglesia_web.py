...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Iglesia.nombre'
        db.delete_column(u'db_iglesia', 'nombre')

        # Adding field 'Iglesia.web'
        db.add_column(u'db_iglesia', 'web',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Iglesia.nombre'
        raise RuntimeError("Cannot reverse this migration. 'Iglesia.nombre' and its values cannot be restored.")
        # Deleting field 'Iglesia.web'
        db.delete_column(u'db_iglesia', 'web')
