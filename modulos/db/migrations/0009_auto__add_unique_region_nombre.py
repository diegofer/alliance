...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Region', fields ['nombre']
        db.create_unique(u'db_region', ['nombre'])


    def backwards(self, orm):
        # Removing unique constraint on 'Region', fields ['nombre']
        db.delete_unique(u'db_region', ['nombre'])
