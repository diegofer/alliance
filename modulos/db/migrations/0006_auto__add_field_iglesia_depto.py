...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Iglesia.depto'
        db.add_column(u'db_iglesia', 'depto',
                      self.gf('django.db.models.fields.CharField')(default='region', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Iglesia.depto'
        db.delete_column(u'db_iglesia', 'depto')
    ...
    models = {
        ...
        u'db.iglesia': {
            ...
            'depto': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
