...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Iglesia.region'
        db.add_column(u'db_iglesia', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['db.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Iglesia.region'
        db.delete_column(u'db_iglesia', 'region_id')
    ...
    models = {
        ...
        u'db.iglesia': {
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['db.Region']"}),
